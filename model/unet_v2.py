...
class UNet(nn.Module):
    ...
    def __init__(self, img_channels, model_config):
        super().__init__()
        ...
        for i in reversed(range(len(self.down_channels) - 1)):
            print("channels:", i,  self.down_channels[i + 1], self.down_channels[i])
    ...
    def forward(self, x, t):
        ...
        t_emb = self.get_position_embedding(torch.as_tensor(t).long(), self.t_emb_dim)
    ...
    def get_position_embedding(self, time_steps, temb_dim):
        """
